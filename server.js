const http = require('http'),
    ...
    proxy = new (require('./api/index'))(config.prefix, {
    ...
    app = (req, res) => {
      ...
      const error = () => (res.statusCode = 404, res.end(fs.readFileSync(__dirname + '/api/error.html', 'utf-8').replace('%ERR%', `Cannot ${req.method} ${req.pathname}`)))
